...
<body id="news-article">
  ...
  <section id="news-article-page">
    <div id="news-content">
      <div class="section-heading">
        <h5 class="date dark-beige-text" style="--color: var(--yellow)">August 2, 2020</h5>
        <a href="news.php" class="button">BACK TO NEWS <?php echo file_get_contents("images/svg-arrow.svg"); ?></a>
      </div>
      <h1>IP leaders confer Honorary Datu title on MAFI Chairman</h1>
